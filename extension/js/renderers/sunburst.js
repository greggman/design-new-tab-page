import { ctx, thirds, shuffle, chance, rand, ri, choice, line, rings, mix, rrange } from '../utils.js';
export default function sunburst() {
  ...
  rrange(0, rays, i => line({ x: fx, y: fy, len: span, rot: off + i * arc / rays, thick: rand(2, 7), color: i % 2 ? cs[i % cs.length] : mix(ctx.P.ink, ctx.P.bg, .5), z: 1 }));
