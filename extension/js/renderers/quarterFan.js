import { ctx, rand, ri, shuffle, line, chance, mix, rings, rrange } from '../utils.js';
...
export default function quarterFan() {
  ...
  rrange(0, n, i => line({ x: px, y: py, len: span, rot: start + (i + .5) / n * 90, thick: rand(3, 11), color: i % 2 ? cs[i % cs.length] : mix(ctx.P.ink, ctx.P.bg, .5), z: 1 }));
