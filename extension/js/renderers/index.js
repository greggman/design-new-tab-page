...
export const SYSTEMS = [
  ...
  ['Concentric squares', concentricSquares, .25],
  ['Sunburst', sunburst, .45],
  ['Pie wheel', pieWheel, .4],
  ['Tessellation', tessellation, .55],
  ['Overlap', overlap, .2],
  ['Nested polygons', nestedPolys, .35],
  ['Arc stacks', arcStacks, .4],
  ['Circle packing', circlePack, .45],
  ['Swiss bands', swissBands, .3],
  ['Diagonal field', diagonalField, .3],
  ['Triangle rows', triangleRows, .4],
  ['Spiral', spiral, .35],
  ['Scallop grid', scallopGrid, .4],
  ['Orbit', orbit, .4],
  ['Phyllotaxis', phyllotaxis, .5],
  ['Isometric', isometric, .45],
  ['Mondrian', mondrian, .4],
  ['Pinwheel', pinwheel, .45],
  ['Wave grid', waveGrid, .45],
  ['Corner arcs', cornerArcs, .4],
  ['Brick wall', brickWall, .4],
  ['Cross-hatch', crossHatch, .2],
  ['Truchet', truchet, .5],
  ['Halftone', halftone, .5],
  ['Homage', albers, .3],
  ['Bauhaus', bauhaus, .3],
  ...
  ['Windmill tiles', windmillTiles, .5],
  ['Ripple', ripple, .45],
  ['Aurora', aurora, .3],
  ['Seigaiha', seigaiha, .45],
  ['Color field', colorField, .3],
  ['Contour lines', contourLines, .35],
  ['Polka dots', polkaDots, .4],
  ['Plaid', plaid, .35],
  ['Basketweave', weave, .45],
  ['Terrazzo', terrazzo, .4],
  ['Memphis', memphis, .4],
  ['Mountains', mountains, .4],
  ['Arc tiles', arcTiles, .5],
  ['Checkerboard', checkerboard, .5],
  ['Warped checker', checkerWarp, .5],
  ['Golden spiral', goldenSpiral, .3],
  ['Rosette', rosette, .35],
  ['Stained glass', stainedGlass, .5],
  ['Starfield', starfield, .3],
  ['Nested chevrons', nestedChevrons, .3],
  ['Gradient grid', gradientGrid, .4],
  ['Maze', maze, .45],
  ['Shards', shards, .45],
  ['Argyle', argyle, .5],
  ['Warp bands', warpBands, .45],
  ['Perspective grid', perspectiveGrid, .4],
  ['Wireframe tunnel', wireframeTunnel, .4],
  ['Lissajous', lissajous, .3],
  ['Spirograph', spirograph, .3],
  ['Glitch', glitch, .45],
  ['Waveform', waveform, .4],
  ['Hex grid', hexGrid, .5],
  ['Barcode', barcode, .5],
  ['Kaleidoscope', kaleidoscope, .45],
  ['Op waves', opWaves, .45],
  ['Hypno rays', hypnoRays, .45],
  ['Plasma', plasma, .3],
  ['Dot sphere', dotSphere, .4],
  ['Star flare', starFlare, .3],
  ['Chrome rings', chromeRings, .3],
  ['Zoom lines', zoomLines, .35],
  ['Suprematism', suprematism, .3],
  ['Flow field', flowField, .35],
  ['Quilt', quilt, .5],
  ['Interference', interference, .45],
  ['Iso city', isoCity, .45],
  ['Cross-stitch', crossStitch, .45],
  ['Warp grid', warpGrid, .35],
  ['Mosaic', mosaic, .5],
  ['Spectrum rings', spectrumRings, .45],
  ['Galaxy', galaxy, .35],
  ['Hatch cells', hatchCells, .4],
  ['Dither', dither, .5],
  ['Low poly', lowPoly, .5],
  ['Lattice', lattice, .35],
  ['Bokeh', bokeh, .3],
  ...
  ['Mudcloth', mudcloth, .5],
  ['Bubbles', bubbles, .35],
  ['Shell fan', shellFan, .4],
  ['Café wall', cafeWall, .5],
  ['Herringbone', herringbone, .5],
  ['Houndstooth', houndstooth, .45],
  ['Voronoi', voronoi, .45],
  ['Penrose', penrose, .4],
  ...
  ['Bulge grid', anamorph, .45],
  ['Tie-dye', tieDye, .35],
  ['Marble', marble, .4],
  ['Camouflage', camouflage, .4],
  ['Leopard', leopard, .4],
  ['Topographic', topographic, .45],
  ['Guilloché', guilloche, .4],
  ['Circuit board', circuitBoard, .45],
  ['Subway map', subwayMap, .4],
  ['Bargello', bargello, .45],
  ['Pixel sprite', pixelSprite, .4],
  ['Atomic', atomic, .4],
  ['Coin stacks', coinStacks, .4],
  ['Tunnel', perspectiveTunnel, .4],
  ['Drop shapes', dropShapes, .4],
  ['Koch snowflake', koch, .35],
  ['Spheres', spheres, .4],
  ['Squiggle', squiggle, .4],
  ['Retro arcs', retroArcs, .45],
  ['Art deco', artDeco, .45],
  ['Doodle grid', doodleGrid, .45],
  ['Concentric polygons', concentricPoly, .4],
  ['Blobs', blobScribble, .4],
  ['Arc loops', arcLoops, .4],
  ['Geo grid', geoGrid, .5],
  ['Constructivist', constructivist, .45],
  ['Ogee', ogee, .5],
  ['Molten', molten, .4],
  ['Groovy', groovy, .4],
  ['Retro frames', retroFrames, .5],
  ['Asterisks', asterisks, .5],
  ['Geo blocks', geoBlocks, .5],
