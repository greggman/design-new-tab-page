...
const COVERERS = new Set([
  ...
  'Doodle grid', 'Concentric polygons', 'Squiggle', 'Arc loops', 'Geo grid', 'Constructivist', 'Ogee', 'Molten', 'Groovy', 'Retro frames', 'Asterisks', 'Geo blocks', 'Nested tiles', 'Atomic diamond', 'Mobiles',
]);
