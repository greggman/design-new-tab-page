...
const NO_ROTATE = new Set(['Perspective grid', 'Sunrise', 'Mountains', 'Staircase', 'Bar stack', 'Waveform', 'Coin stacks', 'Art deco']);
...
const COVERERS = new Set([
  ...
  'Doodle grid', 'Concentric polygons', 'Squiggle', 'Arc loops',
]);
